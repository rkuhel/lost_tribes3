...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { description: @beer.description, image_url: @beer.image_url, price: @beer.price, title: @beer.title }
    end
  ...
  test "should update beer" do
    patch :update, id: @beer, beer: { description: @beer.description, image_url: @beer.image_url, price: @beer.price, title: @beer.title }
    assert_redirected_to beer_path(assigns(:beer))
  end
